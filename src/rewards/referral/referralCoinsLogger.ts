...
export type ReferralCoinsStep =
  ...
  | 'reissue_start'
  | 'reissue_done'
  | 'reissue_staggered_start'
  | 'reissue_staggered_done'
  | 'reissue_kyc_start'
  | 'reissue_kyc_done'
  | 'consumption_grant_blocked'
  | 'consumption_referee_welcome_skipped'
  | 'consumption_referral_grants_skipped'
  | 'consumption_recorded'
  | 'consumption_referee_record_batch_done'
  | 'consumption_referral_record_batch_done'
  | 'api_apply_request'
  | 'api_apply_response'
